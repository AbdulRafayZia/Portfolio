  ...
  return (
    <footer>
      ...
      <div className="footer__socials">
        <a href='https://www.facebook.com/abdul.abdulrafay.33/' target='_blank'><FaFacebookF /></a>
        <a href='https://www.instagram.com/abdul_rafay_zia/' target='_blank'><FiInstagram /></a>
